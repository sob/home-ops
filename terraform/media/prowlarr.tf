provider "prowlarr" {
  url     = module.onepassword_prowlarr.fields.PROWLARR_URL
  api_key = module.onepassword_prowlarr.fields.PROWLARR_API_KEY
}
...
resource "prowlarr_application_lidarr" "lidarr" {
  ...
  prowlarr_url = "http://prowlarr.default.svc.cluster.local"
  api_key = module.onepassword_lidarr.fields.LIDARR_API_KEY
...
resource "prowlarr_application_sonarr" "sonarr" {
  ...
  prowlarr_url = "http://prowlarr.default.svc.cluster.local"
  api_key = module.onepassword_sonarr.fields.SONARR_API_KEY
